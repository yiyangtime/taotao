 ...
 */
function login() {
    return location.href = "http://192.168.0.129:8082/page/login";
}
function regist() {
    return location.href = "http://192.168.0.129:8082/page/register";
}
...
function search(a) {
    var b = "http://192.168.0.129:8081/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
